...
- job history in an automation-owned MariaDB database/account on the shared instance, exposed through the automation API
...
App-specific automation flows can be grouped under `apps/automation/flows/`, while the execution runtime remains shared.
